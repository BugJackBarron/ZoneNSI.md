...
!!! tips 
	...
	![type:video](https://podeduc.apps.education.fr/media/videos/4653d8a4c8f3facf92b5af74e0658ec033c629342b8191d3a039263ad71ba8af/157846/720p.mp4)
	
Observons les codes de la page web (corrigé pour la position de la  balise `<script>`[^Balise]) :

[^Balise]: une vidéo détaillant pourquoi la balise `<script>` doit être placée dans la balise `<body>` est disponible [ici](https://podeduc.apps.education.fr/video/157844-importance-de-la-position-de-la-balise-script/ac0d5a65-8788-4e7a-9013-0fa1bdc11200/){target=_blank}.
